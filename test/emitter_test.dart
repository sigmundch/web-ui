...
main() {
  ...
  group('emit element field', () {
    ...
    group('created', () {
      ...
      test('sibling of a data-bound text node', () {
        var elem = parseSubtree('<div>{{x}}<div></div></div>');
        var emitter = new ElementFieldEmitter(analyzeElement(elem).children[1]);
        expect(_created(emitter), "__e1 = new autogenerated.DivElement();");
      });
  ...
  group('emit text node field', () {
    ...
    test('created', () {
      var elem = parseSubtree('<div>{{bar}}</div>');
      var emitter = new ContentFieldEmitter(analyzeElement(elem).children[0]);
      expect(_created(emitter), equalsIgnoringWhitespace('''
          _binding0 = bar is autogenerated.SafeHtml
          ? new autogenerated.Element.html(bar.toString())
          : new autogenerated.Text(bar.toString());
      '''));
    });
  ...
  group('emit data binding watchers for attributes', () {
    test('declaration', () {
      ...
      var emitter = new AttributeDataBindingEmitter(analyzeElement(elem));
      expect(_declarations(emitter),
    ...
    test('inserted for style', () {
      ...
      var elemField = '__e0';
      var stopperName = '_stopWatcher${elemField}_1';
      var val = 'bar';
      expect(_inserted(emitter), equalsIgnoringWhitespace('''
  ...
  group('emit data binding watchers for content', () {
    test('declaration', () {
      ...
      var emitter = new ContentDataBindingEmitter(
          analyzeElement(elem).children[0]);
      expect(_declarations(emitter),
        equals('autogenerated.WatcherDisposer _stopWatcher_binding0_1;'));
    });
    ...
    test('inserted', () {
      ...
      expect(_inserted(emitter), equalsIgnoringWhitespace(r'''
          _stopWatcher_binding0_1 = autogenerated.watchAndInvoke(() => bar,
              (e) {
                var isSafeHtml = e.newValue is autogenerated.SafeHtml;
                var stringValue = e.newValue.toString();
                if (!isSafeHtml && _binding0 is autogenerated.Text) {
                  _binding0.text = stringValue;
                } else {
                  var oldNode = _binding0;
                  _binding0 = isSafeHtml
                      ? new autogenerated.Element.html(stringValue)
                      : new autogenerated.Text(stringValue);
                  oldNode.replaceWith(_binding0);
                }
              });'''));
    });
