...
main() {
  ...
  group('emit text node field', () {
    test('declaration', () {
      var elem = parseSubtree('<div>{{bar}}</div>');
      var emitter = new TextFieldEmitter(analyzeElement(elem).children[0]);
      expect(_declarations(emitter), 'autogenerated.Text _text0;');
    });
    ...
    test('created', () {
      ...
      var emitter = new TextFieldEmitter(analyzeElement(elem).children[0]);
      expect(_created(emitter),
          '_text0 = new autogenerated.Text(bar.toString());');
    });
    ...
    test('removed', () {
      var elem = parseSubtree('<div>{{bar}}</div>');
      var emitter = new TextFieldEmitter(analyzeElement(elem).children[0]);
      expect(_removed(emitter), '_text0 = null;');
    });
  });
  ...
  group('emit data binding watchers for content', () {
    test('declaration', () {
      ...
      var emitter = new TextDataBindingEmitter(
          analyzeElement(elem).children[0]);
      expect(_declarations(emitter),
        equals('autogenerated.WatcherDisposer _stopWatcher_text0_1;'));
    });
    ...
    test('inserted', () {
      ...
      var emitter = new TextDataBindingEmitter(
          analyzeElement(elem).children[0]);
      expect(_inserted(emitter), equalsIgnoringWhitespace(
          "_stopWatcher_text0_1 = autogenerated.watchAndInvoke(() => bar, "
          "(e) { _text0.text = bar.toString(); });"));
    });
