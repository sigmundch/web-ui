...
main() {
  ...
  group('emit data binding watchers for attributes', () {
    test('declaration', () {
      ...
      var emitter = new SimpleAttributeEmitter(analyzeElement(elem));
      expect(_declarations(emitter),
    ...
    test('inserted for class', () {
      ...
      var emitter = new ClassAttributeEmitter(analyzeElement(elem));
      expect(_inserted(emitter), equalsIgnoringWhitespace('''
          _stopWatcher__e0_1 = autogenerated.watchAndInvoke(() => bar, (e) {
    ...
    test('inserted for style', () {
      ...
      var emitter = new DataStyleAttributeEmitter(analyzeElement(elem));
