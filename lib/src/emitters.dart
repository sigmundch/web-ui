  ...
  CodePrinter run(ComponentInfo info, PathInfo pathInfo,
    ...
    if (codeInfo == null) {
      ...
      codeInfo = new DartCodeInfo(null, null, [],
          ...
          info.declaringFile.path.toString());
    }

    if (transaction == null) {
      transaction = new TextEditTransaction(codeInfo.code,
          codeInfo.sourceMapFile);
    }
...
void emitImports(DartCodeInfo codeInfo, LibraryInfo info, PathInfo pathInfo,
  ...
  var file = codeInfo.sourceMapFile;
  codeInfo.directives.forEach(
      (d) => addUnique(d.toString(), new FileLocation(file, d.offset)));
