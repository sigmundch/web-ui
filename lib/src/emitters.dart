...
import 'package:source_maps/span.dart' show Span, FixedLocation;
...
void _emitClassAttributeBinding(
  ...
  for (int i = 0; i < attr.bindings.length; i++) {
    printer.addLine('__t.bindClass($identifier, () => (${attr.bindings[i]}));',
        span: span);
  }
}
...
void _emitStyleAttributeBinding(
    String identifier, AttributeInfo attr, CodePrinter printer, Span span) {
  printer.addLine('__t.bindStyle($identifier, () => (${attr.boundValue}));',
      span: span);
}
