...
class DartStyleExpression extends ASTNode {
   ...
   */
  abstract merged(DartStyleExpression newDartExpr);
...
class BoxExpression extends DartStyleExpression {
  BoxEdge boxEdge;
   ...
   * same property name (implies same exact type e.g, FontExpression).
   */
  abstract merged(BoxExpression newDartExpr);
