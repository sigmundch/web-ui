...
//  static final int HEX_INTEGER = 61;            // TODO(terry): must match base
  ...
  static final List<Map> _UNITS = const [
  ...
  static final List<Map> _EXTENDED_COLOR_NAMES = const [
...
class TokenChar {
  ...
  static final int LBRACK = 0x5b; // "[".charCodeAt(0)
  static final int RBRACK = 0x5d; // "]".charCodeAt(0)
  static final int LBRACE = 0x7b; // "{".charCodeAt(0)
  static final int RBRACE = 0x7d; // "}".charCodeAt(0)
  static final int DOT = 0x2e; // ".".charCodeAt(0)
  static final int SEMICOLON = 0x3b; // ";".charCodeAt(0)
  static final int AT = 0x40; // "@".charCodeAt(0)
  static final int HASH = 0x23; // "#".charCodeAt(0)
  static final int PLUS = 0x2b; // "+".charCodeAt(0)
  static final int GREATER = 0x3e; // ">".charCodeAt(0)
  static final int TILDE = 0x7e; // "~".charCodeAt(0)
  static final int ASTERISK = 0x2a; // "*".charCodeAt(0)
  static final int NAMESPACE = 0x7c; // "|".charCodeAt(0)
  static final int COLON = 0x3a; // ":".charCodeAt(0)
  static final int PRIVATE_NAME = 0x5f; // "_".charCodeAt(0)
  ...
  static final int PERCENT = 0x25; // "%".charCodeAt(0)
  ...
  static final int EQUALS = 0x3d; // "=".charCodeAt(0)
  static final int OR = 0x7c; // "|".charCodeAt(0)
  static final int CARET = 0x5e; // "^".charCodeAt(0)
  static final int DOLLAR = 0x24; // "\$".charCodeAt(0)
  static final int LESS = 0x3c; // "<".charCodeAt(0)
  static final int BANG = 0x21; // "!".charCodeAt(0)
