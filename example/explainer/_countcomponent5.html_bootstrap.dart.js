...
$$.WebComponent = {"":
 ...
 createShadowRoot$0: function() {
  var shadowRoot = null;
  if ($.WebComponent__hasShadowRoot === true)
    try {
      shadowRoot = $.ShadowRoot_ShadowRoot(this._element);
      shadowRoot.set$resetStyleInheritance(false);
    } catch (exception) {
      $.unwrapException(exception);
      $.WebComponent__hasShadowRoot = false;
    }
...
$.init_autogenerated = function() {
  var _root = $.DocumentFragment_DocumentFragment$html('<div class="well">\n<div data-value="count: myNumber" id="__e-2" is="x-click-counter"></div>\n<div data-value="count: 5" id="__e-3" is="x-click-counter"></div>\n</div>\n');
...
$.WebComponent__hasShadowRoot = true;
$._watchers = null;
$.___e3 = null;
